	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'performance',title:'工作业绩',width:100,sortable: true},
 		        {field:'honor',title:'荣誉称号',width:150,sortable: true},
 		        {field:'worktime',title:'从事岗位时间',width:150,sortable: true},
 		        {field:'tel',title:'Tel',width:150},
	 		]], 
	 		 toolbar: "#toolbar"
	    }); 
	    //设置分页控件 
	    ...
	    $("#addDialog").dialog({
							...
							$.ajax({
								...
								success: function(data){
									if(data.type == "success"){
										...
										$("#add_performance").textbox('setValue', "");
										$("#add_honor").textbox('setValue', "");
										$("#add_worktime").textbox('setValue', "");
	  	...
	  	$("#editDialog").dialog({
			...
			onBeforeOpen: function(){
				...
				$("#edit_performance").textbox('setValue', selectRow.performance);
				$("#edit_honor").textbox('setValue',selectRow.honor);
				$("#edit_worktime").textbox('setValue', selectRow.worktime);
	...
	<div id="addDialog" style="padding: 10px;" >  
   		<form id="addForm" method="post">
	    	<table id="addTable" cellpadding="8">
	    		...
	    		<tr>
	    			<td>工作业绩:</td>
	    			<td><input id="add_performance" style="width: 200px; height: 30px;" class="easyui-textbox" type="performance" name="performance"   /></td>
	    		</tr>
	    		<tr>
	    			<td>荣誉称号:</td>
	    			<td><input id="add_honor" style="width: 200px; height: 30px;" class="easyui-textbox" type="honor" name="honor" d /></td>
	    		</tr>
	    		<tr>
	    			<td>从事岗位时间:</td>
	    			<td><input id="add_worktime" style="width: 200px; height: 30px;" class="easyui-textbox" type="worktime" name="worktime"   /></td>
	    		</tr>
	    		<tr>
	    			<td>Tel:</td>
	    			<td><input id="add_Tel" style="width: 200px; height: 30px;" class="easyui-textbox" type="tel" name="tel" data-options="required:true, missingMessage:'请填写电话号码'"  /></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
	...
	<div id="editDialog" style="padding: 10px">
    	<form id="editForm" method="post">
	    	...
	    	<table id="editTable" border=0 cellpadding="8" >
	    		...
	    		<tr>
	    			<td>工作业绩:</td>
	    			<td><input id="edit_performance" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="performance"  /></td>
	    		</tr>
	    		<tr>
	    			<td>荣誉称号:</td>
	    		...
	    		<tr>
	    			<td>从事岗位时间:</td>
	    			<td><input id="edit_worktime" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="worktime"  /></td>
	    		</tr>
	    		<tr>
	    			<td>Tel:</td>
	    			<td><input id="edit_Tel" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="Tel" data-options="required:true, missingMessage:'请填写电话号码'"  /></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
