	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'xh',title:'学号',width:150, sortable: true},
	    ...
	    $("#addDialog").dialog({
	  	...
	  	$("#editDialog").dialog({
			...
			onBeforeOpen: function(){
				...
				$("#edit_xh").textbox('setValue', selectRow.xh);
		...
		<form id="photoForm" method="post" enctype="multipart/form-data" action="upload_photo" target="photo_target">
	    	<table id="addTable1" cellpadding="8">
	    		<tr >
	    			<td>预览头像:</td>
	    			<td>
	    				<img id="photo-preview" alt="照片" style="max-width: 100px; max-height: 100px;" title="照片" src="/StudentManagerSSM/photo/touxiang.jpg" />
	    			</td>
	    		</tr>
	    		<tr >
	    			<td>学生头像:</td>
   		...
   		<form id="addForm" method="post">
	    	<table id="addTable2" cellpadding="8">
	    		...
	    		<tr >
	    			<td>学号:</td>
	    			<td>
	    				<input id="add_xh"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="xh" data-options="required:true, missingMessage:'请填写登录学号'"  />
	    			</td>
	    		</tr>
	    	    <tr >
	    			<td>所属班级:</td>
    	...
    	<form id="editPhotoForm" method="post" enctype="multipart/form-data" action="upload_photo" target="photo_target">
	    	<table id="editTable1" cellpadding="8">
	    		<tr >
	    			<td>预览头像:</td>
	    			<td>
	    				<img id="edit-photo-preview" alt="照片" style="max-width: 100px; max-height: 100px;" title="照片" src="/StudentManagerSSM/photo/touxiang.jpg" />
	    			</td>
	    		</tr>
	    		<tr >
	    			<td>学生头像:</td>
   		...
   		<form id="editForm" method="post">
	    	...
	    	<table id="editTable2" cellpadding="8">
	    		<input id="edit_photo" type="hidden" name="photo" value="/StudentManagerSSM/photo/touxiang.jpg"  />
	    		<c:if test="${userType == 1||userType == 3}">
	    		<tr >
	    			<td>学生姓名:</td>
	    			<td>
	    		...
	    		<tr >
	    			<td>学号:</td>
	    			<td>
	    				<input id="edit_xh"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="xh"  />
	    			</td>
	    		</tr>
	    		<tr >
	    			<td>所属班级:</td>
	    			<td>
	    				<select id="edit_clazzId"  class="easyui-combobox" style="width: 200px;" name="clazzId">
	    					<c:forEach items="${ clazzList}" var="clazz">
	    						<option value="${clazz.id }">${clazz.name }</option>
	    					</c:forEach>
	    				</select>
