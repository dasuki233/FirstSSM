	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				...
				{field:'id',title:'ID',width:50, sortable: true},
 		        ...
 		        {field:'duikou',title:'是否专业',width:300,sortable: true},
 		        //自愿申请由学生自己填写
 		        //此处给予修改信息权限
 		        ]], 
	        toolbar: "#toolbar"
	    ...
	    $("#addDialog").dialog({
	  	...
	  	$("#editDialog").dialog({
			...
			onBeforeOpen: function(){
				...
				$("#edit_duikou").combobox('setValue', selectRow.duikou);
			}
	    });
...
<body>
	...
	<div id="toolbar">
		...
		<div>
			...
			<input class="easyui-linkbutton" type="button" value="点击此处查看可申请公司"  id="get_applymsg" style="color:red;font-size:18px;" onclick="window.open('../applymsg/list')" />
			<!-- 点击事件查看招聘公司信息 -->
		</div>
	</div>
	...
	<div id="addDialog" style="padding: 10px;">  
   		<form id="addForm" method="post">
	    	<table id="addTable" cellpadding="8">
	    		...
	    		<tr>
	    			<td><input id="add_remark"  type="hidden" name="remark" value="志愿申请"   /></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
	...
	<div id="editDialog" style="padding: 10px">
    	<form id="editForm" method="post">
	    	...
	    	<table id="editTable" border=0 cellpadding="8" >
	    		...
	    		<tr>
	    			<td><input id="edit_remark"  type="hidden" name="remark" value="志愿申请"   /></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
